...
type ProofSpec struct {
	...
	// HashOp to validate the given key
	PrehashComparedKey HashOp `protobuf:"varint,5,opt,name=prehash_compared_key,json=prehashComparedKey,proto3,enum=ics23.HashOp" json:"prehash_compared_key,omitempty"`
	// HashOp to valiudate the given value
	PrehashComparedValue HashOp `protobuf:"varint,6,opt,name=prehash_compared_value,json=prehashComparedValue,proto3,enum=ics23.HashOp" json:"prehash_compared_value,omitempty"`
}
...
func (m *ProofSpec) GetPrehashComparedKey() HashOp {
	if m != nil {
		return m.PrehashComparedKey
	}
	return HashOp_NO_HASH
}

func (m *ProofSpec) GetPrehashComparedValue() HashOp {
	if m != nil {
		return m.PrehashComparedValue
	}
	return HashOp_NO_HASH
}
...
var fileDescriptor_855156e15e7b8e99 = []byte{
	...
	,
}
...
func (m *ProofSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.PrehashComparedValue != 0 {
		i = encodeVarintProofs(dAtA, i, uint64(m.PrehashComparedValue))
		i--
		dAtA[i] = 0x30
	}
	if m.PrehashComparedKey != 0 {
		i = encodeVarintProofs(dAtA, i, uint64(m.PrehashComparedKey))
		i--
		dAtA[i] = 0x28
	}
	if m.MinDepth != 0 {
...
func (m *ProofSpec) Size() (n int) {
	...
	if m.PrehashComparedKey != 0 {
		n += 1 + sovProofs(uint64(m.PrehashComparedKey))
	}
	if m.PrehashComparedValue != 0 {
		n += 1 + sovProofs(uint64(m.PrehashComparedValue))
	}
	return n
}
...
func (m *ProofSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrehashComparedKey", wireType)
			}
			m.PrehashComparedKey = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProofs
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PrehashComparedKey |= HashOp(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrehashComparedValue", wireType)
			}
			m.PrehashComparedValue = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProofs
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PrehashComparedValue |= HashOp(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
