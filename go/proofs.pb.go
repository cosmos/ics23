...
type LeafOp struct {
	...
	PrefixPrehashKey []byte `protobuf:"bytes,6,opt,name=prefix_prehash_key,json=prefixPrehashKey,proto3" json:"prefix_prehash_key,omitempty"`
	// fixed bytes that act as a domain separator for prehash_value
	PrefixPrehashValue []byte `protobuf:"bytes,7,opt,name=prefix_prehash_value,json=prefixPrehashValue,proto3" json:"prefix_prehash_value,omitempty"`
}
...
func (m *LeafOp) GetPrefixPrehashKey() []byte {
	if m != nil {
		return m.PrefixPrehashKey
	}
	return nil
}

func (m *LeafOp) GetPrefixPrehashValue() []byte {
	if m != nil {
		return m.PrefixPrehashValue
	}
	return nil
}
...
var fileDescriptor_855156e15e7b8e99 = []byte{
	...
	,
}
...
func (m *LeafOp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PrefixPrehashValue) > 0 {
		i -= len(m.PrefixPrehashValue)
		copy(dAtA[i:], m.PrefixPrehashValue)
		i = encodeVarintProofs(dAtA, i, uint64(len(m.PrefixPrehashValue)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.PrefixPrehashKey) > 0 {
		i -= len(m.PrefixPrehashKey)
		copy(dAtA[i:], m.PrefixPrehashKey)
		i = encodeVarintProofs(dAtA, i, uint64(len(m.PrefixPrehashKey)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Prefix) > 0 {
...
func (m *LeafOp) Size() (n int) {
	...
	l = len(m.PrefixPrehashKey)
	if l > 0 {
		n += 1 + l + sovProofs(uint64(l))
	}
	l = len(m.PrefixPrehashValue)
	if l > 0 {
		n += 1 + l + sovProofs(uint64(l))
	}
	return n
...
func (m *LeafOp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrefixPrehashKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrefixPrehashKey = append(m.PrefixPrehashKey[:0], dAtA[iNdEx:postIndex]...)
			if m.PrefixPrehashKey == nil {
				m.PrefixPrehashKey = []byte{}
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrefixPrehashValue", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrefixPrehashValue = append(m.PrefixPrehashValue[:0], dAtA[iNdEx:postIndex]...)
			if m.PrefixPrehashValue == nil {
				m.PrefixPrehashValue = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
