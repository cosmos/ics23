...
type ProofSpec struct {
	...
	PrehashCompareKey bool `protobuf:"varint,5,opt,name=prehash_compare_key,json=prehashCompareKey,proto3" json:"prehash_compare_key,omitempty"`
}
...
func (m *ProofSpec) GetPrehashCompareKey() bool {
	if m != nil {
		return m.PrehashCompareKey
	}
	return false
}
...
var fileDescriptor_5e599a3f914c9389 = []byte{
	...
	,
}
...
func (m *ProofSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrehashCompareKey", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
